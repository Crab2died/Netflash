...
import com.github.crab2died.netflash.protocol.codec.hessian.HessianResponseDecoder;
...
public class NetflashClient implements Client {

    private String serverAddress = "127.0.0.1:8200";

    public NetflashClient(String serverAddress) {

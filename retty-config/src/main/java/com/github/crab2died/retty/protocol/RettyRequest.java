...
public class RettyRequest implements Serializable{
    ...
    public RettyRequest(String requestId, long sessionId, String version, String interfaceName, String methodName,
